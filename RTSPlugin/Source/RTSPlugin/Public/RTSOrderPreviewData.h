...
#include "RTSOrderPreviewSnapMode.h"
...
struct RTSPLUGIN_API FRTSOrderPreviewData
{
...
private:
    ...
    UPROPERTY(EditDefaultsOnly, BlueprintReadOnly, Category = "RTS", meta = (AllowPrivateAccess = "true"))
    ERTSOrderPreviewSnapMode SnapMode = ERTSOrderPreviewSnapMode::ORDERPREVIEW_DontSnap;
};