...
#include UE_INLINE_GENERATED_CPP_BY_NAME(RTSGameplayAbility)
...
ERTSOrderTargetType URTSGameplayAbility::GetTargetType() const
{
    return TargetType;
}
...
void URTSGameplayAbility::FormatDescription_Implementation(const FText& InDescription, const AActor* Actor, FText& OutDescription) const
{
...
void URTSGameplayAbility::GetSourceTagRequirements(FGameplayTagContainer& OutRequiredTags, FGameplayTagContainer& OutBlockedTags) const
{
    OutRequiredTags.AppendTags(SourceRequiredTags);
    OutBlockedTags.AppendTags(SourceBlockedTags);
}

void URTSGameplayAbility::GetTargetTagRequirements(FGameplayTagContainer& OutRequiredTags, FGameplayTagContainer& OutBlockedTags) const
{
    OutRequiredTags.AppendTags(TargetRequiredTags);
    OutBlockedTags.AppendTags(TargetBlockedTags);
}

float URTSGameplayAbility::GetRange(const FGameplayAbilitySpecHandle Handle, const FGameplayAbilityActorInfo* ActorInfo, const FGameplayAbilityActivationInfo ActivationInfo) const
{
    return GetRange();
}
...
FScalableFloat URTSGameplayAbility::GetCost() const
{
    return Cost;
}
